...
class LoadImages:  # for inference
    def __init__(self, path, img_size=640):
        ...
        # converter to convert images to normal field of view
        self.nfov = NFOV()
        self.center_point = np.array([0.5, 0.43])  # camera center point (valid range [0,1])
    ...
    def __next__(self):
        ...
        # convert image to normal field of view
        img0 = self.nfov.toNFOV(img0, self.center_point)
